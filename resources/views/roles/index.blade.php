...
@section('content')
    ...
    <div class="content-box">
                                    ...
                                    <div class="table-actions-align">
                                        ...
                                        @can('role-permission-index')
                                            <a href="{{ route('role-permissions.index', ['role' => $d->id]) }}"
                                                class="items-center hidden space-x-1 btn-info md:flex">
                                        ...
                                        @can('role-edit')
                                            <a href="{{ route('roles.edit', ['role' => $d->id]) }}"
        ...
        @else
            <!-- Mensagem de Nenhum Papel Encontrado -->
            <div class="flex flex-col items-center justify-center py-20 text-center text-gray-500">
                ...
                <p class="text-lg font-medium">Nenhum Papel encontrado.</p>
                <p class="text-sm text-gray-400">Tente ajustar os filtros de pesquisa ou adicione um novo Papel.</p>
            </div>
        @endif
