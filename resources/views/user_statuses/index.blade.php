    ...
    <div class="content-box">
                                ...
                                <td class="table-actions">
                                    <div class="table-actions-align">
                                        ...
                                        @can('user-status-edit')
                                            <a href="{{ route('user_statuses.edit', ['userStatus' => $d->id]) }}"
                                        ...
                                        @can('user-status-destroy')
                                            <form action="{{ route('user_statuses.destroy', ['userStatus' => $d->id]) }}"
                                                method="POST"
        ...
        @else
            ...
            <div class="flex flex-col items-center justify-center py-20 text-center text-gray-500">
                ...
                <p class="text-lg font-medium">Nenhum Stautus encontrado.</p>
            </div>
        @endif
